    ...
    <n-layout-header bordered style="height: 50px; display: flex; align-items: center; padding: 0 20px">
      ...
      <div style="display: flex; align-items: center; gap: 8px">
        <button class="theme-toggle" @click="theme.toggle" :title="theme.isDark ? 'Switch to Light' : 'Switch to Dark'">
          <svg v-if="theme.isDark" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="5"/><line x1="12" y1="1" x2="12" y2="3"/><line x1="4.22" y1="4.22" x2="5.64" y2="5.64"/><line x1="18.36" y1="18.36" x2="19.78" y2="19.78"/><line x1="1" y1="12" x2="3" y2="12"/></svg>
        ...
        <button v-if="auth.isLoggedIn" class="logout-btn" @click="handleLogout">Logout</button>
      </div>
    </n-layout-header>
